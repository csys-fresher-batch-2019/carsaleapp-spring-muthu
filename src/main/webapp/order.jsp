...
<div class="card-body">
<table>
<tr><td>BuyerName</td><td>: <input type="text" name="BuyerName" placeholder="BuyerName" required/></td></tr>
...
<tr><td>StreetName</td><td>: <input type="text" name="address1" placeholder="streetName" required/></td></tr>

<tr><td>StreetNO</td><td>: <input type="text" name="address2"placeholder="streetNo" /></td></tr>
